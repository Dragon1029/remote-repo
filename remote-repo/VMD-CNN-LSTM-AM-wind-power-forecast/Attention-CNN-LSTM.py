...
AT+LSTM+CNN 2022.9.25
batch_size = 32,epochs=30,LSTM 100,200,Dense 100,1
均方误差: 20792.381523
均方根误差: 144.195636
平均绝对误差: 99.328701
平均绝对百分误差: 0.555831
...
# plt.legend()
# plt.savefig('./at_cnn_lstm.png')
# plt.show()

model.save('CNN-Attention-LSTM_epochs_{}_batch-size_{}.h5'.format(epochs, batch_size))
print('Model Saved!')
